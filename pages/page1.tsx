...
const Content = () => (
  <div>
    ...
    <iframe style={{ border: "1px solid rgba(0, 0, 0, 0.1)" }} width="800" height="450" src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2F4Jzao4KyvOV95foRLBsTmn%2FNewsKit-Theme-Demo%3Fnode-id%3D1028%253A69125" allowFullScreen></iframe>
  </div>
);
